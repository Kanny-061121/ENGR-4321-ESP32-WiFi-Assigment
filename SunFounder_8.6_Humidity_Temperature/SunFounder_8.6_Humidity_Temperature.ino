...
// SunFounder's code for Project 8.6 ESP32 Online Tutorial. Some SunFounder's comments were removed. 
...
#define AIO_USERNAME "YOUR_ADAFRUIT_IO_USERNAME"    //User Name
#define AIO_KEY      "YOUR_ADAFRUIT_IO_KEY"         //Key
